...
final notificationAPIProvider = Provider((ref) {
  return NotificationAPI(db: ref.watch(appWriteDatabaseProvider), realtime: ref.watch(appWriteRealTimeProvider),);
});
...
class NotificationAPI implements INotificationAPI {
  ...
  NotificationAPI({required Databases db, required Realtime realtime}) : _realtime = realtime,  _db = db;
